...
/*
  Create a function named addTwo which accepts a number, adds 2 to the number 
...
let newAddTwoArray = addTwoToArray([1,2,3,4],addTwo);
console.log(newAddTwoArray);
/*
...
let newAddThreeArray = addThreeToArray([1,2,3,4],addThree);
console.log(newAddThreeArray);
...
let newAddFiveArray = addTwoToArray([1,2,3,4],addFive);
console.log(newAddFiveArray);
...
/*
  Create a function called sendMessage that accepts two arguments:
    ...
    - it will return the result of the callback function called with the 
    message as argument
...
/*
 ...
 Create a function named `first` that accepts an argument a function (callback) and
  return the same function defination.
...
/*
 Create a function named `second`
  - Inside second create another function named `third` which accepts a number, adds 
  1 to it and returns it
...
/*
  Create a function named isAdult which accepts:
    - an object
    - returns true or false based on the `age` property in the object
     is greater than 18 or not
...
/*
  Create a function named isGradeA which accepts:
    - an object
    - returns true or false based on the `grade` property in the object is greater
     than 12 or not
...
/*
  Create a function named isGradeB which accepts:
    - an object
    - returns true or false based on the `grade` property in the object is 
    greater than 8 and less than or equal to 12 or not
...
/*
  Create a function named isGradeC which accepts:
    - an object
    - returns true or false based on the `grade` property in the object is 
    less than or equal to 8  or not
...
function filterAdult(arr){
  ...
  //valid = isAdult(arr[num]);
   if (isAdult(arr[i]) == true){
     newArr.push(arr[i]);
   }
  }
  return newArr;
...
this by making a higher order function named filter. Now using one function filter
 we will be able to filter anything we want.
